export const industryData = {
    ar: {
        ...
        medical: {
            ...
            heroDescription: "اجعل عيادتك تعمل بكفاءة 24/7. موظفونا الأذكياء متخصصون في جدولة المواعيد الطبية، الإجابة على استفسارات المرضى، وتنظيم سجلاتهم بدقة طبية عالية.",
        ...
        real_estate: {
            ...
            heroDescription: "حوّل استفسارات واتساب إلى صفقات حقيقية. موظفونا الأذكياء مدربون على عرض العقارات، الرد على اعتراضات العملاء، وتصنيف المهتمين بدقة عالية.",
            ...
            recommendations: [
                ...
                },
                {
                    ...
                    desc: "يقوم الموظف بتحديد ميزانية العميل واحتياجاته قبل تحويله لموظف المبيعات البشري.",
                    iconName: "UserCheck",
                    animationPath: "/animations/realestate-client.json"
                }
            ],
        ...
        beauty: {
            ...
            heroDescription: "موظف الاستقبال الذكي ينظم حجوزات الأميرات، ينسق جداول الخبيرات، ويقترح الخدمات الإضافية لزيادة أرباح صالونك بكل رقة واحترافية.",
        ...
        restaurant: {
            ...
            heroDescription: "لا تفقد زبوناً بسبب انشغال الخط. موظفنا الذكي يدير الحجوزات، يؤكد المواعيد، وينظم قائمة الانتظار بأسلوب يفتح الشهية للزيارة.",
        ...
        fitness: {
            ...
            heroDescription: "حوّل ناديك الرياضي إلى بيئة تفاعلية. موظفنا الذكي يحجز حصص التدريب، يتابع التزامات المشتركين، ويجيب على استفسارات الاشتراكات والبرامج.",
            img: "https://images.pexels.com/photos/1552242/pexels-photo-1552242.jpeg?auto=compress&cs=tinysrgb&w=800",
            quote: "الالتزام هو سر النجاح، وموظفنا هنا ليضمن التزام عملائك بأهدافهم الرياضية.",
            recommendations: [
                {
        ...
        retail_ecommerce: {
            ...
            heroDescription: "حوّل زوار متجرك الإلكتروني إلى عملاء دائمين. موظفونا الأذكياء متخصصون في إتمام عمليات البيع، الرد على استفسارات المنتجات، ومتابعة السلال المتروكة بدقة فائقة.",
        ...
        banking: {
            ...
            heroDescription: "ارتقِ بتجربة عملائك المصرفية. موظفونا الأذكياء مدربون على تقديم الدعم الفوري للاستفسارات المالية، شرح المميزات البنكية، وتسهيل الإجراءات الإدارية بأمان تام.",
        ...
        call_center: {
            ...
            heroDescription: "حوّل مركز الاتصال الخاص بك إلى منظومة رقمية لا تعرف الكلل. موظفونا الأذكياء يديرون آلاف المحادثات في الوقت ذاته بدقة 90%، مما يقلل الضغط على فريقك البشري.",
        ...
        telecom_it: {
            ...
            heroDescription: "ارتقِ بخدماتك التقنية. موظفونا الأذكياء مدربون على تقديم الدعم الفني المبدئي، شرح باقات الإنترنت، وتنسيق زيارات المهندسين لعملائك بدقة متناهية.",
