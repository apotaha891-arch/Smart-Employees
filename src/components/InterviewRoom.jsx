...
- **FAQ:** Working hours: 9 AM to 5 PM. Headquartered in Riyadh, offering remote services across the Gulf.
            ...
            const identityData = {
                name: agentName,
                role: `AI Digital Employee candidate for the role of: ${targetTemplate.title} (${targetTemplate.specialty})`,
...
3. Show intelligence and after 3 turns, suggest they hire you.
...
${industryPrivacyRules}
            ...
            initializeChat(protectedPrompt, 'interview');
