        ...
        <div className="animate-fade-in">
            ...
            <section className="container" style={{ paddingTop: '5rem', paddingBottom: '5rem' }}>
                <div className="page-header text-center" style={{ marginBottom: '3.5rem' }}>
                    <h2 style={{ marginBottom: '0.75rem', fontSize: '2.5rem', fontWeight: 800 }}>رؤى مخصصة لنمو قطاع {
            ...
            <section className="container" style={{ paddingTop: '6rem', paddingBottom: '6rem' }}>
                <div style={{
                    ...
                    <div style={{ position: 'relative', zIndex: 2 }}>
                        <h2 style={{ color: 'white', marginBottom: '2rem', fontSize: '2.5rem', fontWeight: 900, lineHeight: '1.3' }}>هل أنت مستعد لنقل {profile?.business_name || 'منشأتك'} إلى العصر الذكي؟</h2>
