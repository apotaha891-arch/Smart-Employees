    ...
    if (!partner) return (
        <AcademyLayout>
            <div style={{ textAlign: 'center', padding: '10rem 2rem' }}>
                ...
                <p style={{ color: '#9CA3AF', fontSize: '1.2rem', maxWidth: '600px', margin: '0 auto 3rem' }}>
                ...
                <button 
                    ...
                    style={{ background: '#8B5CF6', color: 'white', padding: '1.25rem 3rem', borderRadius: '16px', fontWeight: 900, fontSize: '1.1rem', border: 'none', cursor: 'pointer' }}
                >
            ...
            <div style={{ padding: '4rem 0' }}>
                <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center', marginBottom: '4rem', gap: '2rem', flexWrap: 'wrap' }}>
                    <div>
                        ...
                        <p style={{ color: '#9CA3AF', fontSize: '1.1rem' }}>{t('أهلاً بك مجدداً.. تابع نمو أرباحك وتأثيرك هنا.', 'Welcome back.. track your earnings and impact here.')}</p>
                    </div>
                    
                    <div style={{ background: '#111827', padding: '1.5rem', borderRadius: '24px', border: '1px solid rgba(139, 92, 246, 0.3)', minWidth: '350px' }}>
                        ...
                        <div style={{ display: 'flex', gap: '10px' }}>
                            ...
                            <button onClick={copyLink} style={{ background: copied ? '#10B981' : '#8B5CF6', color: 'white', border: 'none', borderRadius: '12px', width: '45px', display: 'flex', alignItems: 'center', justifyContent: 'center', cursor: 'pointer', transition: '0.2s' }}>
                ...
                <div style={{ display: 'grid', gridTemplateColumns: 'repeat(auto-fit, minmax(250px, 1fr))', gap: '1.5rem', marginBottom: '4rem' }}>
                    <div style={{ background: 'rgba(139, 92, 246, 0.05)', padding: '2rem', borderRadius: '24px', border: '1px solid rgba(139, 92, 246, 0.1)' }}>
                        ...
                        <div style={{ color: '#9CA3AF', fontSize: '0.9rem', marginBottom: '5px' }}>{t('إجمالي المهتمين (Leads)', 'Total Leads')}</div>
                    ...
                    <div style={{ background: 'rgba(16, 185, 129, 0.05)', padding: '2rem', borderRadius: '24px', border: '1px solid rgba(16, 185, 129, 0.1)' }}>
                        ...
                        <div style={{ color: '#9CA3AF', fontSize: '0.9rem', marginBottom: '5px' }}>{t('التحويلات الناجحة', 'Conversions')}</div>
                    ...
                    <div style={{ background: 'rgba(59, 130, 246, 0.05)', padding: '2rem', borderRadius: '24px', border: '1px solid rgba(59, 130, 246, 0.1)' }}>
                        ...
                        <div style={{ color: '#9CA3AF', fontSize: '0.9rem', marginBottom: '5px' }}>{t('إجمالي الأرباح المستحقة', 'Total Earnings')}</div>
                ...
                <div style={{ background: '#111827', borderRadius: '24px', border: '1px solid rgba(255,255,255,0.05)', overflow: 'hidden' }}>
                    <table style={{ width: '100%', borderCollapse: 'collapse', textAlign: isArabic ? 'right' : 'left' }}>
                        ...
                        <tbody>
                            {leads.length === 0 ? (
                                ...
                                <tr key={lead.id} style={{ borderBottom: '1px solid rgba(255,255,255,0.02)', transition: '0.2s' }}>
                                    <td style={{ padding: '1.25rem', fontWeight: 700 }}>{lead.full_name}</td>
                                    <td style={{ padding: '1.25rem', color: '#9CA3AF' }}>{lead.industry}</td>
