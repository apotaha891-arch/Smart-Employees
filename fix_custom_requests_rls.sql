...
-- 4. Create Policy: Allow ANYONE (or Authenticated) to INSERT
-- Usually for requests, we allow public insert so even visitors can request
...
-- 6. Scalable visibility for Admins
